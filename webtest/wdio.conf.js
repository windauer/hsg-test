...
process.env.WDIO_USER = process.env.WDIO_USER || 'admin'
process.env.WDIO_PASSWORD = process.env.WDIO_PASSWORD || ''
...
exports.config = {
    ...
    // Patterns to exclude.
    // exclude: [
    //     './test/specs/mainPageLinks.spec.js'
    // ],
    //
    // ============
    // Capabilities
    ...
    before: function() {
        ...
        // ensure minimum viewportsize in order to 'see' certain elements in phantomJS
